        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetedSpecialty = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DefaultWatchKeywords = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CvFacts", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "JobApplicationVersions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    JobApplicationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LatexSource = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobApplicationVersions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SavedSearchId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    PollingInterval = table.Column<TimeSpan>(type: "time", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TailoredCvJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CoverLetterText = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LatexSource = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AtsScore = table.Column<double>(type: "float", nullable: false),
                    AtsSuggestionsJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    FollowUpReminderAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobApplicationVersions_UserId",
                table: "JobApplicationVersions",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobOffers_UserId_Source_ExternalId",
                table: "JobOffers",
